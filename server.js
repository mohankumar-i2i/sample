...
var SampleApp = function() {
    ...
    self.setupVariables = function() {
        ...
        if (typeof self.ipaddress === "undefined") {
            ...
            console.warn('No IPADDRESS var, using 127.0.0.1');
    ...
    self.createRoutes = function() {
        ...
        self.routes['/applications'] = function(req, res) {
            res.json({
                user: 'tobi'
            });
            res.status(500).json({
    ...
    self.initializeServer = function() {
        self.createRoutes();
        self.app = express();
        self.app.use(express.static(__dirname + '/angular'));
